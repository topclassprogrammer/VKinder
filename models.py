...
class Search(Base):
    ...
    profile_photo_1 = sq.Column(sq.String(255))
    profile_photo_2 = sq.Column(sq.String(255))
    profile_photo_3 = sq.Column(sq.String(255))
    tagged_photo_1 = sq.Column(sq.String(255))
    tagged_photo_2 = sq.Column(sq.String(255))
    tagged_photo_3 = sq.Column(sq.String(255))
